    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MusteriAd = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RiskLimit = table.Column<int>(type: "int", nullable: false),
                    FaturaAdres = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StokAdi = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Miktar = table.Column<int>(type: "int", maxLength: 128, nullable: false),
                    Tutar = table.Column<decimal>(type: "decimal(18,3)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnayBilgisi = table.Column<bool>(type: "bit", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppOrderMasters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppOrderMasters_AppCustomers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AppCustomers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppOrderMasters_AppOrderDetails_OrderDetailId",
                        column: x => x.OrderDetailId,
                        principalTable: "AppOrderDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppCustomers_MusteriAd",
                table: "AppCustomers",
                column: "MusteriAd");

            migrationBuilder.CreateIndex(
                name: "IX_AppOrderMasters_CustomerId",
                table: "AppOrderMasters",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_AppOrderMasters_OrderDetailId",
                table: "AppOrderMasters",
