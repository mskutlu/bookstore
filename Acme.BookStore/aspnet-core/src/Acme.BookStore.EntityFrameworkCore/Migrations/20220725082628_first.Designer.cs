...
namespace Acme.BookStore.Migrations
{
    ...
    [Migration("20220725082628_first")]
    partial class first
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.BookStore.Customers.Customer", b =>
                {
                    ...
                    b.HasIndex("MusteriAd");

                    b.ToTable("AppCustomers", (string)null);
                });

            modelBuilder.Entity("Acme.BookStore.OrderDetails.OrderDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.BookStore.OrderMasters.OrderMaster", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppOrderMasters", (string)null);
                });
            ...
            modelBuilder.Entity("Acme.BookStore.OrderMasters.OrderMaster", b =>
                {
                    b.HasOne("Acme.BookStore.Customers.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Acme.BookStore.OrderDetails.OrderDetail", null)
                        .WithMany()
